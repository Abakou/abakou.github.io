    ...
    <main className='max-w-screen-xl mx-auto'>
      <section className='lg:flex  gap-20 items-center py-20 px-6 xl:px-0'>
        <div className='w-full'>
          ...
          <div className='mt-12 flex gap-6 items-center mb-16 lg:mb-0'>
            <a href="" className='font-mono dark:bg-yellow-600  bg-yellow-500  px-5 py-2.5 rounded-full hover:px-8 transition-all'>
